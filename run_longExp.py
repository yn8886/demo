...
parser.add_argument('--model', type=str, default='PDF',
...
parser.add_argument('--kernel_list', type=int, nargs='+', default=[5, 7, 11, 15], help='kernel size list')
parser.add_argument('--patch_len', type=int, nargs='+', default=[11, 16], help='patch high')
parser.add_argument('--period', type=int, nargs='+', default=[112, 336], help='period list')
parser.add_argument('--stride', type=int, nargs='+', default=[7, 14], help='stride')
